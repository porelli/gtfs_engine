...
# -*- encoding: utf-8 -*-
# stub: gtfs_engine 2.1.0 ruby lib

Gem::Specification.new do |s|
  s.name = "gtfs_engine".freeze
  s.version = "2.1.0"
  ...
  s.homepage = "http://github.com/sangster/gtfs_engine".freeze
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<activerecord-import>.freeze, ["~> 1.0"])
      s.add_runtime_dependency(%q<gtfs_reader>.freeze, ["~> 4.0"])
      s.add_runtime_dependency(%q<rails>.freeze, [">= 5.0", "< 7.0"])
      s.add_runtime_dependency(%q<responders>.freeze, ["~> 3.0"])
      s.add_runtime_dependency(%q<jbuilder>.freeze, ["~> 2.10"])
      s.add_runtime_dependency(%q<jsend_wrapper-rails>.freeze, ["~> 0.4"])
      ...
      s.add_dependency(%q<activerecord-import>.freeze, ["~> 1.0"])
      s.add_dependency(%q<gtfs_reader>.freeze, ["~> 4.0"])
      s.add_dependency(%q<rails>.freeze, [">= 5.0", "< 7.0"])
      s.add_dependency(%q<responders>.freeze, ["~> 3.0"])
      s.add_dependency(%q<jbuilder>.freeze, ["~> 2.10"])
      s.add_dependency(%q<jsend_wrapper-rails>.freeze, ["~> 0.4"])
